...
public class Listener
{
  ...
  public Listener(MainActivity mainActivity)
  {
    ...
    mSpeechRecognizer.setRecognitionListener(new RecognitionListenerExtended());
  }
  ...
  class RecognitionListenerExtended implements RecognitionListener
  {
    ...
    public RecognitionListenerExtended()
    {
    }
    ...
    {
      Log.d("foo", "RecognitionListenerExtended onError: " + String.valueOf(error));
    }
